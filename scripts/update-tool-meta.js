...
const META = {
    ...
    'jpg-to-png': 'Convert JPG to PNG online free. Note: this does not add transparency — JPEG has no alpha channel.',
    'png-to-jpg': 'Convert PNG to JPG online free. White background fill, smaller files for web and email. Runs in the tab.',
    ...
    'image-crop': 'Crop images online free. Center-crop to exact pixel width and height. No signup required.',
    'rotate-image': 'Rotate images online free. 90°, 180°, 270° rotation. Canvas size swaps in the tab.',
    ...
    'image-to-base64': 'Image to Base64 encoder online free. For web developers. FileReader in the tab; ads still load.',
