(function () {
    ...
    controls.innerHTML =
        '<div class="ft-row"><label>Brightness: <span id="brightnessValue">0</span></label>' +
        '<input type="range" id="brightnessSlider" min="-100" max="100" value="0"></div>';
    ...
    function filterCss() {
        return 'brightness(' + (100 + parseInt(slider.value, 10)) + '%)';
    }
    ...
    downloadBtn.addEventListener('click', function () {
        ...
        FT.downloadCanvas(canvas, FT.baseName(currentFile, 'brightness') + '.png', 'image/png');
    });
})();
